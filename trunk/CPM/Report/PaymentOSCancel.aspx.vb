...
Partial Class Report_PaymentOSCancel
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not Page.IsPostBack Then
            ...
            sql = "Select DEBTORID,NAME AS DEBTOR,0 as Seq From Debtor Where Status = 'I'" & _
    ...
    Public Sub bindDropDown()
        ...
        Try
            ...
            sql = "Select DEBTORID,NAME AS DEBTOR,0 as Seq From Debtor Where Status = '" & DebtorStatusEnum.INACTIVE & "'" & _
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            rptMgr.setReportName("PaymentOSCancel.Rpt")

...
Partial Class Report_KOIAlert
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not Page.IsPostBack Then
            ...
            x = 0
            For x = x To (x + 100) step 5
                ddpfoc.Items.Add(x)
            Next x

	    x = 0
            For x = x To (x + 200) step 5
                ddpos.Items.Add(x)
            Next x
	...
	Dim SeasonName As String = ""
        ...
        Try
            ...
            rptMgr.setReportName("KOIAlert.Rpt")
            ...
            rptMgr.setParameterDiscrete("pfoc", ddpfoc.SelectedValue)
            rptMgr.setParameterDiscrete("pos", ddpos.SelectedValue)
            rptMgr.setParameterDiscrete("pbmr", ddpbmr.SelectedValue)

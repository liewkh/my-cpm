<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SeasonRevLineGraph.aspx.vb" Inherits="Report_SeasonRevLineGraph" %>
...
<html>
<head>
<title>Season Revenue Line Graph</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Season Revenue Line Graph</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DebitNoteDetail.aspx.vb" Inherits="Report_DebitNote" %>
...
<html>
<head>
<title>Invoice/Debit Note Detail</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Invoice/Debit Note Detail</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   

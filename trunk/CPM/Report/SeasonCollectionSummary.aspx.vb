...
Partial Class Report_SeasonCollectionSummary
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not Page.IsPostBack Then
            ...
            x = myYear - 5
            For x = x To (x + 10)
                ddStartYear.Items.Add(x)
                ddEndYear.Items.Add(x)
            Next x

            ddStartYear.Items.FindByText(myYear).Selected = True
            ddEndYear.Items.FindByText(myYear + 1).Selected = True

            'ddStartMonth.Items.FindByText(myMonth).Selected = True
            'ddEndMonth.Items.FindByText(myMonth + 1).Selected = True
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            rptMgr.setReportName("SeasonCollectionSummary.Rpt")
            ...
            rptMgr.setParameterDiscrete("sMonth", ddStartMonth.SelectedValue)
            rptMgr.setParameterDiscrete("eMonth", ddEndMonth.SelectedValue)
            rptMgr.setParameterDiscrete("sYear", ddStartYear.SelectedValue)
            rptMgr.setParameterDiscrete("eYear", ddEndYear.SelectedValue)

...
Partial Class Report_ParkingCancellation
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
	    ...
	    sql = "Select DEBTORID,NAME AS DEBTOR,0 as Seq From Debtor Where " & _                
		"LocationInfoId = " & lp.getDefaultLocationInfoId & " UNION ALL SELECT CODEMSTRID,CODEDESC,SEQ FROM CODEMSTR WHERE CODECAT = 'ALL'" & _
                "ORDER BY SEQ,DEBTOR"
    ...
    Public Sub bindDropDown()
        ...
        Try
            ...
            sql = "Select DEBTORID,NAME AS DEBTOR,0 as Seq From Debtor WHERE " & _
                        "LocationInfoId = " & ddLocation.SelectedValue & " UNION ALL SELECT CODEMSTRID,CODEDESC,SEQ FROM CODEMSTR WHERE CODECAT = 'ALL'" & _
                        "ORDER BY SEQ,DEBTOR"
	...
	Dim debtorId As String = ""
	    ...
	    If dddebtor.SelectedIndex = 0 Then
            ...
            rptMgr.setReportName("ParkingCancellation.Rpt")

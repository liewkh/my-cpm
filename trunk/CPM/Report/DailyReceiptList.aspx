<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DailyReceiptList.aspx.vb" Inherits="Report_DailyReceiptList" %>
...
<html>
<head>
<title>Daily Receipt List With PassCard</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Daily Receipt List</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
 ...
 <tr>
                        <td class="normalLabel">Receipt Date From <font color="#FF0000">*</font></td>
                        <td class="hSpace">&nbsp;</td>
                    ...
                    <tr>
                        <td class="normalLabel">Receipt Date To <font color="#FF0000">*</font></td>
                        <td class="hSpace">&nbsp;</td>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KOIAlert.aspx.vb" Inherits="Report_KOIAlert" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
<title>KOI Exception Listing</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">KOI Exception Listing</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
...
<tr>
		<td class="normalLabel">Waiver Ticket Greater Than  <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddpfoc" runat="server" AutoPostBack="true"></asp:DropDownList>&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
      	<td class="hSpace">&nbsp;</td>
...
<tr>
		<td class="normalLabel">BMR Greater Than  <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddpbmr" runat="server" AutoPostBack="true"></asp:DropDownList>&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
      	<td class="hSpace">&nbsp;</td>
...
<tr>
		<td class="normalLabel">O/S Ticket Greater Than  <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddpos" runat="server" AutoPostBack="true"></asp:DropDownList>&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
      	<td class="hSpace">&nbsp;</td>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OfficialReceiptSummary.aspx.vb" Inherits="Report_OfficialReceiptSummary" %>
...
<html>
<head>
<title>Official Receipts Summary</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Official Receipt Summary</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   

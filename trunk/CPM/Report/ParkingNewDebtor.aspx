<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ParkingNewDebtor.aspx.vb" Inherits="Report_ParkingNewDebtor" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">New Debtor Listing</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
 ...
 <tr>
                        <td class="normalLabel">Commencement Date From <font color="#FF0000">*</font></td>
                        <td class="hSpace">&nbsp;</td>
                    ...
                    <tr>
                        <td class="normalLabel">Commencement Date To <font color="#FF0000">*</font></td>
                        <td class="hSpace">&nbsp;</td>

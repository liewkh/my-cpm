<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ParkingCancellation.aspx.vb" Inherits="Report_ParkingCancellation" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Parking Cancellation - Only VERIFIED cancellation record will be listed</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
	...
	<tr class="vSpace">
                        <td class="normalLabel">[Debtor]</td>
                        <td class="hSpace">&nbsp;</td>
                        <td nowrap><asp:DropDownList ID="ddDebtor" runat="server" TabIndex="2" DataSourceID="dsDebtor" DataTextField="debtor" DataValueField="debtorid" CssClass="dropdownLarge">
                            </asp:DropDownList><asp:SqlDataSource ID="dsDebtor" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>">
                            </asp:SqlDataSource>
                        </td>
                        <td class="hSpace">&nbsp;</td>
                        <td class="hSpace">&nbsp;</td>
 ...
 <tr>
                        <td class="normalLabel">Transaction Date From <font color="#FF0000">*</font></td>
                        <td class="hSpace">&nbsp;</td>
                    ...
                    <tr>
                        <td class="normalLabel">Transaction Date To <font color="#FF0000">*</font></td>
                        <td class="hSpace">&nbsp;</td>

...
Partial Class Report_PassCardListing 
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not Page.IsPostBack Then
            ...
            ddLocation.SelectedValue = lp.getDefaultLocationInfoId
              ...
              sql = "Select distinct NAME AS DEBTORID,NAME AS DEBTOR,0 as Seq From Debtor Where Status = '" & DebtorStatusEnum.ACTIVE & "'" & _
                "And LocationInfoId = " & lp.getDefaultLocationInfoId & " UNION ALL SELECT CODEDESC,CODEDESC,SEQ FROM CODEMSTR WHERE CODECAT = 'ALL'" & _
               "ORDER BY SEQ,DEBTOR"
    ...
    Public Sub bindDropDown()
        ...
        Try
            ...
            sql = "Select distinct NAME AS DEBTORID,NAME AS DEBTOR,0 as Seq From Debtor Where Status = '" & DebtorStatusEnum.ACTIVE & "'" & _
                        "And LocationInfoId = " & ddLocation.SelectedValue & " UNION ALL SELECT CODEDESC,CODEDESC,SEQ FROM CODEMSTR WHERE CODECAT = 'ALL'" & _
                        "ORDER BY SEQ,DEBTOR"
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs)
	    ...
	    If ddStatus.SelectedIndex = 0 Then
            ...
            rptMgr.setReportName("PassCardListingNonIU.Rpt")
	    ...
	    rptMgr.setParameterDiscrete("status", status)

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserAccessList.aspx.vb" Inherits="Report_UserAccessList" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">&nbsp;Access List</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
	...
	<tr>
		...
		<td class="hSpace">&nbsp;</td>
	    <td nowrap><asp:DropDownList ID="ddAccessLevel" runat="server" TabIndex="11" DataSourceID="dsAccessLevel" DataTextField="codedesc" DataValueField="codeabbr" CssClass="dropdownLarge"></asp:DropDownList><asp:SqlDataSource ID="dsAccessLevel" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>"
                                            SelectCommand="select codeabbr,codedesc,0 as seq from codemstr where codecat='LVL' and Active='Y' union all select codeabbr,codedesc,seq from codemstr where codecat = 'ALL' order by seq,codedesc">
                                        </asp:SqlDataSource>
		</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CardInventory.aspx.vb" Inherits="Report_CardInventory" %>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Card Inventory</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
...
<tr>
		<td class="normalLabel">Company Level</td>
		<td class="hSpace">&nbsp;</td>
        <td><asp:CheckBox ID="chkCompanyLevel"  AutoPostBack ="true" Checked ="false"   TabIndex="3" runat="server" OnCheckedChanged="chkCompanyLevel_CheckedChanged"/></td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
      	<td class="hSpace">&nbsp;</td>

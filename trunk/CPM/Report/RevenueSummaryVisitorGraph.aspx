<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RevenueSummaryVisitorGraph.aspx.vb" Inherits="Report_RevenueSummaryVisitorGraph" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
<title>Visitor Revenue Summary By Location</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Visitor Revenue Summary By Location</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   

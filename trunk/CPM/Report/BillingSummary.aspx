<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BillingSummary.aspx.vb" Inherits="Report_BillingSummary" %>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Billing Summary</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
...
<tr>
		<td class="normalLabel">Quarter <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddQuarter" runat="server" AutoPostBack="true">
                                                <asp:ListItem Value="">Please Choose One</asp:ListItem>
                                                <asp:ListItem Value="01">Q1-Jan,Feb,Mac</asp:ListItem>
                                                <asp:ListItem Value="02">Q2-Apr,May,Jun</asp:ListItem>
                                                <asp:ListItem Value="03">Q3-Jul,Aug,Sep</asp:ListItem>
                                                <asp:ListItem Value="04">Q4-Oct,Nov,Dec</asp:ListItem>                                                
                                            </asp:DropDownList>&nbsp;
		</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>

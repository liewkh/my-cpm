<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InvoiceCancellation.aspx.vb" Inherits="Transaction_InvoiceCancellation" EnableEventValidation ="false"  %>
...
function onUpdating(){
                ...
                var gridView = $get('<%= gvInvoice.ClientID %>');
...
<script language="javascript" type="text/javascript">
    var gridViewCtlId = '<%=gvInvoice.ClientID%>';
                      ...
                      <tr>
                        <td colspan="15">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td bgcolor="white">
                                        <asp:GridView ID="gvInvoice" runat="server" AllowPaging="True" AllowSorting="True" ShowHeader="true"  
                                            AutoGenerateColumns="False" CellPadding="0" Width="100%" BorderWidth="1px" HorizontalAlign="Left"
                                            CellSpacing="1" DataKeyNames="DEBTORACCOUNTHEADERID,DEBTORID,INVOICEDATE,INVOICENO,INVOICEPERIOD,AMOUNT,TXNTYPEDESC"
                                        ...
                                        <asp:SqlDataSource ID="dsInvoice" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>"
                                            ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>

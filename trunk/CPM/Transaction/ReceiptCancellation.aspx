<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReceiptCancellation.aspx.vb" Inherits="Transaction_BillCancellation" EnableEventValidation="false"  %>
...
function onUpdating(){
                ...
                var gridView = $get('<%= gvReceipt.ClientID %>');
...
<%--<script language="javascript" type="text/javascript">
    var gridViewCtlId = '<%=gvReceipt.ClientID%>';
    ...
    {
        var selRow = getSelectedRow(parseInt(rowIdx)+1);
        if (curSelRow != null)
        {
...
<body> 
<form id="Form1" action='' runat="server"  onsubmit="return true;" >
	...
	<tr>
		<td class="header1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="hSpace">&nbsp;</td>
					<td class="header1" style="border:none;">Receipt</td>
					<td>&nbsp;</td>
					<td colspan = "8">&nbsp;</td>
        <td class="hSpace">&nbsp;</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
		...
		<td class="header2" colspan="15" style="height: 35px">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  ...
			  <td class="hSpace">&nbsp;</td>
			<asp:HiddenField ID="hidDebtorPaymentId" runat="server"/>		
			<asp:HiddenField ID="hidDebtorId" runat="server"/>		
			<asp:RequiredFieldValidator ID="Remark" runat="server" ControlToValidate="txtRemark" Display="None" ErrorMessage="Remark is a required field."></asp:RequiredFieldValidator></tr>
		  </table>
		</td>
	</tr>
  ...
  <div id="divInv" runat="server" visible="false">
    
    <tr>
		<td class="normalLabel">Remark <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
		<td><asp:TextBox ID="txtRemark" runat="server" CssClass="textBoxLarge" MaxLength="200" TabIndex="10"></asp:TextBox></td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
	    <td class="hSpace">&nbsp;</td>
                      ...
                      <tr>
                        <td colspan="15">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td bgcolor="white">
                                        <asp:GridView ID="gvReceipt" runat="server" AllowPaging="True" AllowSorting="True" ShowHeader="true"  
                                            AutoGenerateColumns="False" CellPadding="0" Width="100%" BorderWidth="1px" HorizontalAlign="Left"
                                            CellSpacing="1" DataKeyNames="DEBTORPAYMENTID,DEBTORID,PAYMENTDATE,RECEIPTNO,DESCRIPTION,AMOUNT,TXNTYPEDESC"
                                            DataSourceID="dsReceipt">
                                            <Columns>
                                            ...
                                            <SelectedRowStyle CssClass="tb-highlightSelected" />
                                            <HeaderStyle CssClass="grid_header" HorizontalAlign="Left" VerticalAlign="Middle" />
                                            
                                            <PagerStyle Font-Bold="True" Font-Underline="True" />
                                        </asp:GridView>
                                        <asp:SqlDataSource ID="dsReceipt" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>"
                                            ProviderName="System.Data.SqlClient"></asp:SqlDataSource>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        ...
                        <td height="22" colspan="11" align="right">
                            <asp:Button ID="btnConfirm" runat="server" Text="Confirm" CssClass="buttonMedium" CausesValidation="false"
                                TabIndex="15" OnClick="btnConfirm_Click" onclientclick="return confirm('Are you sure you want to Cancel?')" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ParkingCancellationVerification.aspx.vb" Inherits="Verification_ParkingCancellationVerification" %>
...
<head>
    <title>Parking Cancellation Verification</title>
...
<script language="javascript" type="text/javascript">
         ...
         function onUpdating(){
                        ...
                        var gridView = $get('<%= gvPCV.ClientID %>');
	...
	<tr>
		<td class="header1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="hSpace">&nbsp;</td>
					<td class="header1" style="border:none;">Parking Cancellation&nbsp;</td>
					<td>&nbsp;</td>
					<td colspan = "8">&nbsp;</td>
        <td class="hSpace">&nbsp;</td>
		...
		<td class="header2" colspan="15" style="height: 35px">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Verification&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>
		</td>
                    ...
                    <tr>
                        <td colspan="15">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td bgcolor="white">
                                        <asp:GridView ID="gvPCV" runat="server" AllowPaging="True" AllowSorting="True"
                                            AutoGenerateColumns="False" CellPadding="0" Width="100%" BorderWidth="1px" HorizontalAlign="Left"
                                            CellSpacing="1" DataKeyNames="DEBTORPASSBAYNOCANCELID,DEBTOR,CANCELLATIONDATE,SERIALNO,REASON,REMARK,DEPOSIT,OUTSTANDING,UNUSED,EFFECTIVEFROM,DEPOSITDESC,
                                               PROCESSEDBY,LUB,LUDT"
                                            DataSourceID="dsPCV">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DEBTOR" HeaderText="Debtor Name" SortExpression="DEBTOR"
                                                    NullDisplayText="N/A" />
                                                <asp:BoundField DataField="CANCELLATIONDATE" HeaderText="Cancellation Date" SortExpression="CANCELLATIONDATE"
                                                    NullDisplayText="N/A" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" />
                                                <asp:BoundField DataField="EFFECTIVEFROM" HeaderText="Effective Date" SortExpression="EFFECTIVEFROM"
                                                    NullDisplayText="N/A" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" />    
                                                <asp:BoundField DataField="SERIALNO" HeaderText="Serial No" SortExpression="SERIALNO"
                                                    NullDisplayText="N/A" />
                                                <asp:BoundField DataField="DEPOSITDESC" HeaderText="Deposit" SortExpression="DEPOSITDESC"
                                                    NullDisplayText="N/A" />
                                                <asp:BoundField DataField="OUTSTANDING" HeaderText="Outstanding" SortExpression="OUTSTANDING"
                                                    NullDisplayText="N/A" />
                                                <asp:BoundField DataField="UNUSED" HeaderText="Unused" SortExpression="UNUSED"
                                                    NullDisplayText="N/A" />                                                     
                                        ...
                                        <asp:SqlDataSource ID="dsPCV" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>"
		...
		<td colspan="15" height="17"></td>
                    ...
                    <tr>
                        ...
                        <td height="22" colspan="11" align="right">
                            <asp:Button ID="btnConfirm" runat="server" Text="Confirm" OnClick="btnConfirm_Click"  CssClass="buttonMedium" CausesValidation="true"
                                TabIndex="15"/>  
                        </td>
                        <td class="hSpace" height="22">
                            &nbsp;</td>

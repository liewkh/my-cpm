...
Partial Class Enquiry_RcpDebitEnq
    ...
    Protected Sub gvDebtorRcp_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvDebtorRcp.RowCommand
        'For Sorting
        If Not e.CommandName.Equals("Select") Then
            SearchData()
        End If

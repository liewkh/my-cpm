<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ParkingCancellationEnq.aspx.vb" Inherits="Enquiry_ParkingCancellationEnq" EnableEventValidation ="false"  %>
...
<head id="Head1" runat="server">
    <title>Parking Cancellation Enquiry</title>
...
<script language="javascript" type="text/javascript">
         ...
         function onUpdating(){
                        ...
                        var gridView = $get('<%= gvPC.ClientID %>');
...
<tr>
		<td class="normalLabel">[Year]</td>
		<td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddYear" runat="server"  >
                                                <asp:ListItem Value="">Please Choose One</asp:ListItem>
                    ...
                    <tr>
                        <td colspan="15">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td bgcolor="white">
                                        <asp:GridView ID="gvPC" runat="server" AllowPaging="True" AllowSorting="True" ShowHeader="true"  
                                            AutoGenerateColumns="False" CellPadding="0" Width="100%" BorderWidth="1px" HorizontalAlign="Left"
                                            CellSpacing="1" DataKeyNames=""
                                            DataSourceID="dsPC">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="SERIALNO" HeaderText="Serial No" SortExpression="SERIALNO"
                                                    NullDisplayText="N/A" />      
                                                <asp:BoundField DataField="CANCELLATIONDATE" HeaderText="Trans Date" SortExpression="CANCELLATIONDATE"
                                                    NullDisplayText="N/A" DataFormatString="{0:d}" htmlencode="false" />
                                                <asp:BoundField DataField="EFFECTIVEFROM" HeaderText="W.E.F" SortExpression="EFFECTIVEFROM"
                                                    NullDisplayText="N/A" DataFormatString="{0:d}" htmlencode="false" />
                                        ...
                                        <asp:SqlDataSource ID="dsPC" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InvDebitEnq.aspx.vb" Inherits="Enquiry_InvDebEnq" EnableEventValidation="false"   %>
...
<script language="javascript" type="text/javascript">
         ...
         function onUpdating(){
                        ...
                        var gridView = $get('<%= gvDebtorInv.ClientID %>');
	...
	<tr>
		<td class="header1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="hSpace">&nbsp;</td>
					<td class="header1" style="border:none;">Invoice/Debit Note</td>
					<td>&nbsp;</td>
					<td colspan = "8">&nbsp;</td>
        <td class="hSpace">&nbsp;</td>
                                ...
                                <tr>
                                    <td bgcolor="white">
                                        <asp:GridView ID="gvDebtorInv" runat="server" AllowPaging="True" AllowSorting="True" ShowHeader="true"  
                                            AutoGenerateColumns="False" CellPadding="0" Width="100%" BorderWidth="1px" HorizontalAlign="Left"
                                            CellSpacing="1" DataKeyNames="INVOICEDATE,INVOICENO,INVOICEPERIOD,AMOUNT,STATUS,DEBTORACCOUNTHEADERID,OSAMOUNT,STATUSCODE,TXNTYPEDESC,MIREMARK,PASSCARDNO"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Print" SortExpression="Print"> 
                                                    <ItemTemplate> 
                                                     <asp:Button ID="btnPrint" Text="Print" CommandName="Print" CssClass="buttonMedium"  CommandArgument =  '<%# DataBinder.Eval(Container.DataItem, "INVOICENO") & "|" & DataBinder.Eval(Container.DataItem, "TXNTYPE") & "|" & DataBinder.Eval(Container.DataItem, "MIREMARK") & "|" & DataBinder.Eval(Container.DataItem, "PASSCARDNO") %>' runat="server"></asp:Button> 
                                                    </ItemTemplate> 
                                                </asp:TemplateField>             
                                            </Columns>
                                            <RowStyle CssClass="grid_row1" />

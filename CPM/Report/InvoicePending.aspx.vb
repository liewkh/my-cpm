...
Partial Class Report_InvoicePending
	...
	Dim thedate As String = ""
	    ...
	    thedate = ddYear.SelectedValue & "-" & ddMonth.Selectedvalue & "-01"


            rptMgr.setReportName("InvoicePending.Rpt")
	    ...
	    rptMgr.setParameterDiscrete("thedate", thedate)

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PaymentOutstandingPasscard.aspx.vb" Inherits="Report_PaymentOutstandingPasscard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
<title>Monthly Payment Outstanding List By Passcard</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Monthly Payment Outstanding List By Passcard</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
...
<tr>
    ...
    <tr class="vSpace">
                        <td class="normalLabel">[Season Type]</td>
                        <td class="hSpace">&nbsp;</td>
                        <td nowrap><asp:DropDownList ID="ddSeason" runat="server" TabIndex="3" DataSourceID="dsSeason" DataTextField="seasontypedesc" DataValueField="seasontypemstrid" CssClass="dropdownLarge">
                            </asp:DropDownList><asp:SqlDataSource ID="dsSeason" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>">
                            </asp:SqlDataSource>
                        </td>
                        <td class="hSpace">&nbsp;</td>
                        <td class="hSpace">&nbsp;</td>

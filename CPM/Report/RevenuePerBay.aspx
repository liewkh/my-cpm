<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RevenuePerBay.aspx.vb" Inherits="Report_RevenuePerBay" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
<title>Average Revenue Per Bay</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Average Revenue Per Bay</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   

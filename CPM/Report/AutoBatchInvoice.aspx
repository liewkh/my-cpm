<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AutoBatchInvoice.aspx.vb" Inherits="Report_AutoBatchInvoice" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
	...
	<tr class="vSpace">
        ...
        <td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddLocation" runat="server" TabIndex="3" DataSourceID="dsLocation" DataTextField="locationName" DataValueField="locationinfoid" CssClass="dropdownLarge" OnSelectedIndexChanged="ddLocation_SelectedIndexChanged"></asp:DropDownList><asp:SqlDataSource ID="dsLocation" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>">
                                        </asp:SqlDataSource>
		 </td>
        <td class="hSpace">&nbsp;</td>
      	<td class="hSpace">&nbsp;</td>
...
<tr>
		<td class="normalLabel">Invoice Generation Month <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddMonth" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddMonth_SelectedIndexChanged"  >
	...
	<tr>
		<td class="normalLabel">Batch No <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddBatchNo" runat="server" TabIndex="28" DataSourceID="dsBatchNo" DataTextField="batchNo" DataValueField="batchNo" CssClass="dropdownMedium"></asp:DropDownList><asp:SqlDataSource ID="dsBatchNo" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>">
                                        </asp:SqlDataSource>
		</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>

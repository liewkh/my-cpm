<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DebtorTransList.aspx.vb" Inherits="Report_DebtorTransList" %>
...
<html>
<head>
<title>Debtor Transaction List</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Debtor Transactions List</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CreditNoteDetail.aspx.vb" Inherits="Report_CreditNoteDetail" %>
...
<html>
<head>
<title>Receipt/Credit Note Detail</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Receipt/Credit Note Detail</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
   ...
   <tr class="vSpace">
    ...
    <tr>
		<td class="normalLabel" style="width: 134px; height: 10px;">Transaction Type</td>
		<td class="hSpace" style="height: 10px">&nbsp;</td>
        <td nowrap><asp:DropDownList ID="ddTxnType" runat="server" TabIndex="14" CssClass="dropdownMedium">
                    ...
                    <tr>
                        ...
                        <td class="hSpace">&nbsp;</td>
                         <td class="normalLabel"><asp:TextBox ID="txtTo" runat="server" CssClass="textBoxSmall" MaxLength="12" TabIndex="4"></asp:TextBox>
                            <rjs:PopCalendar ID="popCalendar2" RequiredDate="True" From-Control="txtFrom" From-Date="" From-Increment="0" To-Today = "false" runat="server" Control="txtTo" InvalidDateMessage="Invalid Date Range Selection"
                                Shadow="True" ShowWeekend="True" Move="True" Format="dd mm yyyy" Separator="/" Fade="0.5" ToolTip="Click For Calendar: ([Format])" />
                        </td>
                        <td class="hSpace">&nbsp;</td>
                        <td class="hSpace">&nbsp;</td>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PassCardListingNonIU.aspx.vb" Inherits="Report_PassCardListing" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
<title>Pass Card Listing Not In Used Status</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Pass Card Listing - Non In Used Status</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
    ...
    <tr class="vSpace">
     ...
     <tr class="vSpace">
                        ...
                        <td nowrap><asp:DropDownList ID="ddStatus" runat="server" TabIndex="8" DataSourceID="dsStatus" DataTextField="codeDesc" DataValueField="codeAbbr" CssClass="dropdownMedium">
                                ...
                                SelectCommand="select codeAbbr,codeDesc,0 as seq from codemstr where codecat = 'PCS' and active = 'Y' and codeabbr <> 'IU' union all select  codeabbr,codedesc,seq from codemstr where codecat = 'ALL' order by seq,codedesc">
                            </asp:SqlDataSource>
                        </td>
                        <td class="hSpace">&nbsp;</td>
                        <td class="hSpace">&nbsp;</td>

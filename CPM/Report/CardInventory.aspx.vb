...
Partial Class Report_CardInventory
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            If chkCompanyLevel.Checked = True Then
                rptMgr.setReportName("CardInventoryCompany.Rpt")
            Else
                rptMgr.setReportName("CardInventory.Rpt")
            End If
    ...
    Protected Sub btnClear_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        chkCompanyLevel.Checked = False
    End Sub

    Protected Sub chkCompanyLevel_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If chkCompanyLevel.Checked = True Then
            ddLocation.SelectedIndex = 0

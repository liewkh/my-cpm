<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RevenueGraphYear.aspx.vb" Inherits="Report_RevenueGraphYear" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Yearly Revenue</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   
    ...
    <tr>
	    ...
	    <tr class="vSpace">
                        <td class="normalLabel">[Location] <font color="#FF0000">*</td>
                        <td class="hSpace">&nbsp;</td>
  ...
  <tr>
			...
			<td class="normalLabel">End Month <font color="#FF0000">*</font></td>
                        <td class="hSpace">&nbsp;</td>
                        <td nowrap><asp:DropDownList ID="ddeMonth" runat="server" AutoPostBack="true">
                                                <asp:ListItem Value="">Please Choose One</asp:ListItem>
                                                <asp:ListItem Value="01">January</asp:ListItem>
                                                <asp:ListItem Value="02">February</asp:ListItem>
                                                <asp:ListItem Value="03">March</asp:ListItem>
...
<tr>
  ...
  <tr>
      <td colspan='15' align='right'>
            <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="buttonMedium" CausesValidation="true"

...
Partial Class Report_PaymentOutstandingPasscard
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
	    ...
	    sql  = "select seasontypemstrid, seasontypedesc ,0 as seq from seasontypemstr where locationinfoid = " & lp.getDefaultLocationInfoId & _
                                "union select -1 as codemstrid,codedesc, seq from codemstr where codecat = 'ALL' "

	    dsSeason.SelectCommand = sql
            dsSeason.DataBind()
    ...
    Public Sub bindDropDown()
        ...
        Try
            ...
            sql  = "select seasontypemstrid, seasontypedesc ,0 as seq from seasontypemstr where locationinfoid = " & ddLocation.SelectedValue & _
                                "union select -1 as codemstrid,codedesc, seq from codemstr where codecat = 'ALL' "  
            dsSeason.SelectCommand = sql
            dsSeason.DataBind()
	...
	Dim SeasonName As String = ""
	    ...
	    if ddSeason.SelectedIndex = 0 Then
		SeasonName = "%"
	    Else
                SeasonName = ddSeason.SelectedItem.Text
	    End If
            ...
            rptMgr.setReportName("PaymentOutstandingPasscard.Rpt")
            ...
            rptMgr.setParameterDiscrete("SeasonName", SeasonName)

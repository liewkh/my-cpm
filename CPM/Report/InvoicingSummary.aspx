<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InvoicingSummary.aspx.vb" Inherits="Report_InvoicingSummary" %>
...
<html>
<head>
<title>Monthly Invoicing Summary</title>
		...
		<td class="header2" colspan="15">
		  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
			  <td class="hSpace">&nbsp;</td>
			  <td class="hSpace">&nbsp;</td>
			  <td class="header2" style="border:none;">Monthly Invoicing Summary</td>
			  <td class="hSpace">&nbsp;</td>
			</tr>
		  </table>		   

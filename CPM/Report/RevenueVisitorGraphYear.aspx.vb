...
Partial Class Report_RevenueVisitorGraphYear
    ...
    Protected Sub btnPrint_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim sql As String = ""
	Dim seasonb As integer
	Dim visitorb As integer
	    ...
	    End If
            ...
            If ddMonth.SelectedIndex = 0 Then
                lblMsg.Text = "Please select a Starting Month."
                Exit Sub
            End If

	    If ddeMonth.SelectedIndex = 0 Then
                lblMsg.Text = "Please select a Ending Month."
                Exit Sub
            End If

	    If ddeMonth.SelectedValue < ddMonth.SelectedValue Then
		lblMsg.Text = "Start Month must be before End Month."
                Exit Sub
	    End If
        ...
        Try
            sql = "SELECT seasonbudgetamount, visitorbudgetamount FROM locationinfo WHERE locationinfoid = " & ddLocation.SelectedValue
            dt = dm.execTable(sql)

            If dt.Rows.Count = 0 Then
                seasonb = 0
            Else
                seasonb = dt.Rows(0).Item("seasonbudgetamount") 
		visitorb = dt.Rows(0).Item("visitorbudgetamount")
            End If
        ...
        End Try
            ...
            rptMgr.setReportName("RevenueVisitorGraphYear.Rpt")
	    ...
	    rptMgr.setParameterDiscrete("emonth", ddeMonth.SelectedValue)
 	    rptMgr.setParameterDiscrete("locname", ddlocation.selecteditem.text)
 
            rptMgr.setParameterDiscrete("sbudget", seasonb)
            rptMgr.setParameterDiscrete("vbudget", visitorb)

...
Partial Class Transaction_BillGeneration
    ...
    Protected Sub btnGenerate_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            If ddMonth.SelectedValue <> 12 Then
                nextMonth = strDate.AddMonths(1).ToString("MMM")
            Else
            ...
            If ddDebtor.SelectedIndex = 0 Then 'Generate for all the debtor inside the list
                For i = 0 To ddDebtor.Items.Count - 1
                    ...
                    searchModel.setMonthFrom(ddYear.SelectedValue & ddMonth.SelectedValue.ToString & "01")
                    ...
                    If genFlag Then
                        ...
                        'me.UpdatePanel1     
                        retValue = invMgr.createInvoice(lp.getUserMstrId, ddDebtor.Items(i).Value.ToString, ddMonth.SelectedValue.ToString, array, BatchNo, RptYear, cn, trans)
                        trans.Commit()
                        trans = cn.BeginTransaction
                        genFlag = False
                        array.Clear()

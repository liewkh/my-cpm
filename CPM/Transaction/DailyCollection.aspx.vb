...
Partial Class Transaction_DailyCollection
    ...
    End Sub
    Protected Sub doInsert(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            'validate the location per day is not existed before insert
            ...
            strSQL = sqlmap.getMappedStatement("DailyCollection/Search-DailyCollectionByLocation", searchModel)
            ...
            dailyEnt.setProcessedBy(lp.getUserMstrId)

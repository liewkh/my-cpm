<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManualTaxInvoice.aspx.vb" Inherits="Transaction_ManualTaxInvoice" %>
	...
	<tr>
		<td class="header1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td class="hSpace">&nbsp;</td>
					<td class="header1" style="border:none;">Manual Tax Invoice</td>
					<td>&nbsp;</td>
					<td colspan = "8">&nbsp;</td>
        <td class="hSpace">&nbsp;</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
	...
	<tr class="vSpace">
		...
		<asp:TextBox ID="txtTaxInvoiceDate" runat="server" CssClass="dateBox" Enabled="true" MaxLength="12" TabIndex="2"></asp:TextBox> 
  ...
  <div id="divInv" runat="server" visible="true">
   ...
   <tr class="vSpace">
	...
	<tr class="vSpace">
		...
		<td class="hSpace">&nbsp;</td>
		<td><asp:TextBox ID="txtDescription" runat="server" CssClass="textBoxLarge" TabIndex="11" MaxLength ="200"></asp:TextBox></td>        
        <td class="hSpace">&nbsp;</td>       
        <td class="hSpace">&nbsp;</td>       
        <td class="hSpace">&nbsp;</td>
      	<td class="hSpace">&nbsp;</td>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DebitNote.aspx.vb" Inherits="Transaction_DebitNote" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
	...
	<tr class="vSpace">
		...
		<asp:TextBox ID="txtDebitNoteDate" runat="server" CssClass="dateBox" MaxLength="12" TabIndex="2"></asp:TextBox> 
        <rjs:PopCalendar id="popCalendar1" runat="server"
           Control="txtDebitNoteDate"
  ...
  <div id="divInv" runat="server" visible="true">
    ...
    <tr>
		<td class="normalLabel">Debit Amount (RM) <font color="#FF0000">*</font></td>
		<td class="hSpace">&nbsp;</td>
		<td><asp:TextBox ID="txtDebitAmount" runat="server" CssClass="textBoxMedium" MaxLength="200" TabIndex="12"></asp:TextBox></td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
		<td class="hSpace">&nbsp;</td>
        <td class="hSpace">&nbsp;</td>        
  ...
  <ajaxToolkit:FilteredTextBoxExtender ID="ftbe1" runat="server" TargetControlID="txtDebitAmount" ValidChars="1234567890." />
  
  
  <asp:RegularExpressionValidator ID="v1" runat="server" ControlToValidate="txtDebitAmount" Display="None" ErrorMessage="Invalid format. Debit Amount is a numeric field." ValidationExpression="^[$]?([0-9][0-9]?([,][0-9]{3}){0,4}([.][0-9]{0,4})?)$|^[$]?([0-9]{1,14})?([.][0-9]{1,4})$|^[$]?[0-9]{1,14}$"></asp:RegularExpressionValidator>

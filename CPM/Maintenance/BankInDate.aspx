<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BankInDate.aspx.vb"
    Inherits="Maintenance_BankInDate" %>
...
<html>
<head>
    <title>Bank In Date Setup</title>
...
<script language="javascript" type="text/javascript">
         ...
         function onUpdating(){
                        ...
                        var gridView = $get('<%= gvBankInDate.ClientID %>');
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="header2" colspan="15" align="left">
                            ...
                            <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="errorMsg"
                                DisplayMode="List" />
                            <asp:RequiredFieldValidator ID="EntryDate" runat="server" ControlToValidate="txtEntryDate"
                                Display="None" ErrorMessage="Entry Date is a required field."></asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="BankInDate" runat="server" ControlToValidate="txtBankInDate"
                                Display="None" ErrorMessage="Bank In Date is a required field."></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr class="vSpace">
                        <td>
                    ...
                    <tr>
                        <td class="normalLabel" style="height: 22px">
                            [Entry Date] <font color="#FF0000">*</font></td>
                        <td class="hSpace" style="height: 22px">
                            &nbsp;</td>
                        <td style="height: 22px">
                            <asp:TextBox ID="txtEntryDate" runat="server" CssClass="textBoxSmall" MaxLength="12"
                                TabIndex="1"></asp:TextBox>
                                <rjs:PopCalendar id="popCalendar1" runat="server"
                                     Control="txtEntryDate"
                    ...
                    <tr>
                        <td class="normalLabel" style="height: 22px">
                            [Bank In Date] <font color="#FF0000">*</font></td>
                        <td class="hSpace" style="height: 22px">
                            &nbsp;</td>
                        <td nowrap style="height: 22px">
                            <asp:TextBox ID="txtBankInDate" runat="server" CssClass="textBoxSmall" MaxLength="12"
                    ...
                    <tr>
                        <td colspan="15">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td bgcolor="white">
                                        <asp:GridView ID="gvBankInDate" runat="server" AllowPaging="True" AllowSorting="True"
                                            AutoGenerateColumns="False" CellPadding="0" Width="100%" BorderWidth="1px" HorizontalAlign="Left"
                                            CellSpacing="1" DataKeyNames="CODEMSTRID,ACTIVE,LUDT,LUB" DataSourceID="dsBankInDate">
                                            <Columns>
                                                <asp:BoundField DataField="CODEABBR" HeaderText="Entry Date" SortExpression="CODEABBR"
                                                    NullDisplayText="N/A" />
                                                <asp:BoundField DataField="CODEDESC" HeaderText="Bank In Date" SortExpression="CODEDESC"
                                                    NullDisplayText="N/A" />
                                            </Columns>
                                        ...
                                        <asp:SqlDataSource ID="dsBankInDate" runat="server" ConnectionString="<%$ ConnectionStrings:CPMConnectionString %>"

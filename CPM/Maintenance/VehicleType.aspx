<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VehicleType.aspx.vb" Inherits="Maintenance_VehicleType" %>
...
<html>
<head>
    <title>Vehicle Type Setup</title>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="header2" colspan="15" align="left">
                            ...
                            <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="errorMsg"
                                DisplayMode="List" />
                            <asp:RequiredFieldValidator ID="VehicleType" runat="server" ControlToValidate="txtVehicleType"
                                Display="None" ErrorMessage="Vehicle Code is a required field."></asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="VehicleDesc" runat="server" ControlToValidate="txtVehicleDesc"
                                Display="None" ErrorMessage="Vehicle Description is a required field."></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr class="vSpace">
                        <td>
                    ...
                    <tr>
                        <td class="normalLabel" style="height: 22px">
                            [Vehicle Type] <font color="#FF0000">*</font></td>
                        <td class="hSpace" style="height: 22px">
                            &nbsp;</td>
                        <td style="height: 22px">
                            <asp:TextBox ID="txtVehicleType" runat="server" CssClass="textBoxSmall" MaxLength="50"
                    ...
                    <tr>
                        <td class="normalLabel" style="height: 22px">
                            [Vehicle Description] <font color="#FF0000">*</font></td>
                        <td class="hSpace" style="height: 22px">
                            &nbsp;</td>
                        <td nowrap style="height: 22px">
                            <asp:TextBox ID="txtVehicleDesc" runat="server" CssClass="textBoxLarge" MaxLength="200"
                    ...
                    <tr>
                        <td colspan="15">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td bgcolor="white">
                                        <asp:GridView ID="gvBank" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                            CellPadding="0" Width="100%" BorderWidth="1px" HorizontalAlign="Left" CellSpacing="1"
                                            DataKeyNames="CODEMSTRID,ACTIVE,LUDT,LUB" DataSourceID="dsBank">
                                            <Columns>
                                                <asp:BoundField DataField="CODEABBR" HeaderText="Vehicle Type" SortExpression="CODEABBR"
                                                    NullDisplayText="N/A" />
                                                <asp:BoundField DataField="CODEDESC" HeaderText="Vehicle Description" SortExpression="CODEDESC"
                                                    NullDisplayText="N/A" />
                                            </Columns>

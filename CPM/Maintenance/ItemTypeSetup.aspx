<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ItemTypeSetup.aspx.vb" Inherits="Maintenance_ItemTypeSetup" %>
...
<script language="javascript" type="text/javascript">
         ...
         function onUpdating(){
                        ...
                        var gridView = $get('<%= gvItemType.ClientID %>');
...
<body leftmargin='0' topmargin='0' scroll='auto'>
    <form id="Form1" action='' runat="server" defaultbutton="btnSearch">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" >
		        ...
		        <td class="header2" colspan="15" align ="left" >
		          <table border="0" cellpadding="0" cellspacing="0" width="100%">
			        <tr>
			          ...
			          <td class="hSpace" style="height: 17px">&nbsp;</td>
			          <td class="header2" style="border:none; height: 17px;">Item Type&nbsp;</td>
			          ...
			          <td class="hSpace">&nbsp;</td>
		                 ...
		                 <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="errorMsg"
                                            DisplayMode="List" />
                    <asp:RequiredFieldValidator ID="bankCode" runat="server" ControlToValidate="txtItemTypeCode" Display="None" ErrorMessage="Item Type Code is a required field."></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="bankDesc" runat="server" ControlToValidate="txtItemTypeDesc" Display="None" ErrorMessage="Item Type Description is a required field."></asp:RequiredFieldValidator>
                                    </td>                
	        </tr>
	        ...
	        <tr>
		        <td class="normalLabel" style="height: 22px">[Item Type Code] <font color="#FF0000">*</font></td>		    
		        <td class="hSpace" style="height: 22px">&nbsp;</td>
                <td style="height: 22px"><asp:TextBox ID="txtItemTypeCode" runat="server" CssClass="textBoxSmall" MaxLength="50" TabIndex="1"></asp:TextBox></td>           
		        <td class="hSpace" style="height: 22px">&nbsp;</td>
	        ...
	        <tr>		    
		        <td class="normalLabel" style="height: 22px">[Item Type Description] <font color="#FF0000">*</font></td>
                <td class="hSpace" style="height: 22px">&nbsp;</td>
                <td nowrap style="height: 22px">
                <asp:TextBox ID="txtItemTypeDesc" runat="server" CssClass="textBoxLarge" MaxLength="200" TabIndex="2"></asp:TextBox>
                </td>
		        <td class="hSpace" style="height: 22px">&nbsp;</td>
      	        <td class="normalLabel" style="height: 22px">&nbsp;</td>
		        <td class="hSpace" style="height: 22px">&nbsp;</td>
       ...
       <tr>
            ...
            <tr>
                <td bgcolor="white">
                    <asp:GridView ID="gvItemType" runat="server" AllowPaging="True" AllowSorting = "True" 
                        AutoGenerateColumns="False" CellPadding="0" Width="100%"
                        BorderWidth="1px" HorizontalAlign="Left" CellSpacing="1" DataKeyNames="CODEMSTRID,ACTIVE,LUDT,LUB" DataSourceID="dsItemType">
                        <Columns>
                            <asp:BoundField DataField="CODEABBR" HeaderText="Item Type Code" SortExpression="CODEABBR"
                                NullDisplayText="N/A" />
                            <asp:BoundField DataField="CODEDESC" HeaderText="Item Type Description" SortExpression="CODEDESC"
                                NullDisplayText="N/A" />
                        </Columns>

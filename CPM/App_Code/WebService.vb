...
Public Class WebService
    ...
    <WebMethod()> _
    Public Sub GenerateInvoiceMonthlyAll()
        Dim sql As String = ""
        Dim j As Integer
        Dim invMgr As New InvoiceManager
        Dim retValue As String = ""
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                For Each row As DataRow In dt.Rows
                    ...
                    Dim strSQLCheckOSCounter As String = sqlmap.getMappedStatement("Debtor/Search-DebtorAutoBillGenAll", debtorSearchModel)
                    Dim dtOSCounter As DataTable = dm.execTableInTrans(strSQLCheckOSCounter, cn, trans)
    ...
    <WebMethod()> _
    Public Sub GenerateInvoiceQuarterlyAll()
        Dim sql As String = ""
        Dim j As Integer
        Dim invMgr As New InvoiceManager
        Dim retValue As String = ""
